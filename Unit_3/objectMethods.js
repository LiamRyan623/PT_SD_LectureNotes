...
let theSimpsons = {
  ...
  console.log("Value: ", Object.value(theSimpsons))

  //* Object.create(), uses an existing object t frame out a new object. We use a variable to store the base of the object creation.
