...
/* 
    - Encapsulated data and behavior through an exposed interface. (We can access how we build and store data/dataType values)
    ...
    - Polymorphism of behavior (can act/do any things in it's many forms)
...
//console.log(buttons)
let Naoise = new Pet("Naoise", "buck-skin");
//console.log(Naoise);
//console.log(Naoise.speak());
//console.log(buttons.speak());

//console.log(`${Naoise.name} goes woof!`); // Not as flexible and clean code compared to the method
...
// Ex 1: Change up our Pet class and create a new child called Dog that extends from it.
...
let naoise = new Dog("Naoise", "buck-skin", "Awwwoooo");
console.log(naoise)
console.log(naoise.speak)
...
// Hiding the complexity of how things work via an object and objects methods.
